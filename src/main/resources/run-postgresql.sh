...
POSTGRESQL="$M2_REPOS/org/postgresql/postgresql/$POSTGRESQL_VERSION/postgresql-$POSTGRESQL_VERSION.jar"
...
JARS="$JOOQ/jooq/$JOOQ_VERSION/jooq-$JOOQ_VERSION.jar:$JOOQ/jooq-meta/$JOOQ_VERSION/jooq-meta-$JOOQ_VERSION.jar:$JOOQ/jooq-codegen/$JOOQ_VERSION/jooq-codegen-$JOOQ_VERSION.jar:$REACTIVE_STREAMS:$POSTGRESQL:$jaxb:$r2dbc:.";

java -cp $JARS org.jooq.codegen.GenerationTool ./src/main/resources/gen-postgresql.xml
