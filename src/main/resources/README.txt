...
# Note: Please be sure to include the same version in the pom.xml file, so that the script can find the dependencies for generations.
# Note: Later versions of JOOQ will cause errors and incompatibilities.

# Load the DDL schema in MySQL
DDL_DIR="`dirname \"$0\"`"
mysql -u root -pkillbill killbill < "${DDL_DIR}"/ddl.sql
...
JAVAX_VERSION=2.3.0
$MVN_DOWNLOAD -Dartifact=javax.xml.bind:jaxb-api:$JAVAX_VERSION:jar
...
JAVAX="$M2_REPOS/javax/xml/bind/jaxb-api/$JAVAX_VERSION/jaxb-api-$JAVAX_VERSION.jar"
JOOQ_CODEGEN=$JOOQ/jooq-codegen/$JOOQ_VERSION/jooq-codegen-$JOOQ_VERSION.jar
$JOOQ_CODEGEN

JARS="$JAVAX:$JOOQ/jooq/$JOOQ_VERSION/jooq-$JOOQ_VERSION.jar:$JOOQ/jooq-meta/$JOOQ_VERSION/jooq-meta-$JOOQ_VERSION.jar:$JOOQ/jooq-codegen/$JOOQ_VERSION/jooq-codegen-$JOOQ_VERSION.jar:$REACTIVE_STREAMS:$MYSQL:.";
