...
public class AdyenResponsesRecord extends UpdatableRecordImpl<AdyenResponsesRecord> {
    ...
    private static final long serialVersionUID = -557063182;
     ...
     */
    public AdyenResponsesRecord(ULong recordId, String kbAccountId, String kbPaymentId, String kbPaymentTransactionId, String transactionType, BigDecimal amount, String currency, String pspResult, String pspReference, String authCode, String resultCode, String refusalReason, String reference, String pspErrorCodes, String paymentInternalRef, String formUrl, BigDecimal dccAmount, String dccCurrency, String dccSignature, String issuerUrl, String md, String paRequest, String additionalData, LocalDateTime createdDate, String kbTenantId) {
        super(AdyenResponses.ADYEN_RESPONSES);
        ...
        set(9, authCode);
        set(10, resultCode);
        set(11, refusalReason);
        set(12, reference);
        set(13, pspErrorCodes);
        set(14, paymentInternalRef);
        set(15, formUrl);
        set(16, dccAmount);
        set(17, dccCurrency);
        set(18, dccSignature);
