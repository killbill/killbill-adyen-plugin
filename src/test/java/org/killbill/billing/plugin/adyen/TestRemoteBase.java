...
public abstract class TestRemoteBase {
    ...
    public static final int CC_EXPIRATION_MONTH = 3;
    public static final int CC_EXPIRATION_YEAR = 2030;
    ...
    public static final String CC_3DS2_NUMBER_IDENTIFY_SHOPPER = "5454545454545454";
